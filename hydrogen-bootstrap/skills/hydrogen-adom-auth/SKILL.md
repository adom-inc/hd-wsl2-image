...
[[hydrogen-adom-auth-windows]] companion skill.
...
See the **hydrogen-settings** skill (API Explorer section) for the
...
- **hydrogen-adom-auth-windows** -- host app-data path table + WSL2 specifics
- **hydrogen-ui** -- menu layout, where profile menu lives
- **hydrogen-setup** -- bootstrap steps that depend on auth
- **hydrogen-settings** -- API Explorer (auth endpoints tab)
- **hydrogen-networking** -- control API port (47084)
