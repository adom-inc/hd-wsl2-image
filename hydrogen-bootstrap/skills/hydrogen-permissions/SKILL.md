...
description: >
  ...
  hydrogen-capture-share). HD's webview engine is platform-specific; the per-engine
...
- [hydrogen-open-url](../hydrogen-open-url/SKILL.md) — opening URLs/webview apps inside HD (where these permissions apply)
