...
> (see [hd-adom-desktop](../hd-adom-desktop/SKILL.md)) take true OS screenshots via
...
> [hd-permissions](../hd-permissions/SKILL.md) (WebView2 auto-granting mic/cam OS
...
- [hd-self-screenshot](../hd-self-screenshot/SKILL.md) — CDP per-panel screenshots + shotlog visual-verify loop
- [hd-permissions](../hd-permissions/SKILL.md) — WebView2 auto-granting OS mic/cam/notification permissions (a *different* layer from this consent dialog)
- [hd-adom-desktop](../hd-adom-desktop/SKILL.md) — AD's dialog-free host OS screenshots (`desktop_screenshot_screen/_window`)
