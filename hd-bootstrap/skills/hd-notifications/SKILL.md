...
description: >
  ...
  platform-specific (see [[hd-notifications-windows]] for the Windows path);
...
> (WinRT toasts + taskbar attention — see [[hd-notifications-windows]]); macOS has a more
...
> WinRT/orange-taskbar-flash details live in [[hd-notifications-windows]].
...
- [[hd-notifications-windows]] — the Windows toast backend (WinRT, AUMID "Adom" title, orange taskbar flash)
