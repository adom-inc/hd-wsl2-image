...
> same-port behavior), see **[[hd-desktop-sse-windows]]**.
...
> platform — see **[[hd-desktop-sse-windows]]**.
...
On first launch, defaults are written without scanning. Workspace-side ports (8080, 8765, 8766) are always fixed — only host-side ports are dynamic. The `ports.json` location and relay host mapping are platform-specific — see **[[hd-desktop-sse-windows]]**.
