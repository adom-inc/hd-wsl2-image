...
live in the companion [[hd-setup-windows]] skill.
...
state-file name are platform-specific — see [[hd-setup-windows]].
...
runtime-install reboot are in [[hd-setup-windows]].
...
platform-specific port-forwarding behavior is in [[hd-setup-windows]].
